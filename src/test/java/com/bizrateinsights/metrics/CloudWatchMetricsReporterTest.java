...
public class CloudWatchMetricsReporterTest {
    ...
    public void shouldNotReportIfDisabled() {
        ...
        final SortedMap<String, Gauge> gauges = ImmutableSortedMap.of("gauge", gauge);
        final SortedMap<String, Counter> counters = ImmutableSortedMap.of();
        final SortedMap<String, Histogram> histograms = ImmutableSortedMap.of();
        final SortedMap<String, Meter> meters = ImmutableSortedMap.of();
        final SortedMap<String, Timer> timers = ImmutableSortedMap.of();
    ...
    public void shouldReportGaugesToCloudWatchWithTags() {
        ...
        final MetricDatum expectedMetric = new MetricDatum()
                ...
                .withValue(1.0)
                .withDimensions(ImmutableList.of(new Dimension().withName("key").withValue("value")))
    ...
    public void shouldFilterNonNumericGauges() {
        ...
        final SortedMap<String, Gauge> gauges = ImmutableSortedMap.of("gauge", gauge, "mockGauge", mockGauge);
        final SortedMap<String, Counter> counters = ImmutableSortedMap.of();
        final SortedMap<String, Histogram> histograms = ImmutableSortedMap.of();
        final SortedMap<String, Meter> meters = ImmutableSortedMap.of();
        final SortedMap<String, Timer> timers = ImmutableSortedMap.of();
    ...
    public void shouldReportCountersToCloudWatch() {
        ...
        final SortedMap<String, Gauge> gauges = ImmutableSortedMap.of();
        final SortedMap<String, Counter> counters = ImmutableSortedMap.of("counter", counter);
        final SortedMap<String, Histogram> histograms = ImmutableSortedMap.of();
        final SortedMap<String, Meter> meters = ImmutableSortedMap.of();
        final SortedMap<String, Timer> timers = ImmutableSortedMap.of();
    ...
    public void shouldReportHistogramsToCloudWatch() {
        ...
        final SortedMap<String, Gauge> gauges = ImmutableSortedMap.of();
        final SortedMap<String, Counter> counters = ImmutableSortedMap.of();
        final SortedMap<String, Histogram> histograms = ImmutableSortedMap.of("histogram", histogram);
        final SortedMap<String, Meter> meters = ImmutableSortedMap.of();
        final SortedMap<String, Timer> timers = ImmutableSortedMap.of();
        ...
        final List<MetricDatum> expectedMetrics = ImmutableList.of(
                new MetricDatum().withMetricName("histogram.count").withValue(1.0).withTimestamp(new Date(timestamp)),
                new MetricDatum().withMetricName("histogram.max").withValue(2.0).withTimestamp(new Date(timestamp)),
                new MetricDatum().withMetricName("histogram.min").withValue(3.0).withTimestamp(new Date(timestamp)),
                new MetricDatum().withMetricName("histogram.mean").withValue(4.0).withTimestamp(new Date(timestamp)),
                new MetricDatum().withMetricName("histogram.stddev").withValue(5.0).withTimestamp(new Date(timestamp)),
                new MetricDatum().withMetricName("histogram.median").withValue(6.0).withTimestamp(new Date(timestamp)),
                new MetricDatum().withMetricName("histogram.p75").withValue(7.0).withTimestamp(new Date(timestamp)),
                new MetricDatum().withMetricName("histogram.p95").withValue(8.0).withTimestamp(new Date(timestamp)),
                new MetricDatum().withMetricName("histogram.p98").withValue(9.0).withTimestamp(new Date(timestamp)),
                new MetricDatum().withMetricName("histogram.p99").withValue(10.0).withTimestamp(new Date(timestamp)),
                new MetricDatum().withMetricName("histogram.p999").withValue(11.0).withTimestamp(new Date(timestamp))
        );
    ...
    public void shouldReportMetersToCloudWatch() {
        ...
        final SortedMap<String, Counter> counters = ImmutableSortedMap.of();
        final SortedMap<String, Histogram> histograms = ImmutableSortedMap.of();
        final SortedMap<String, Meter> meters = ImmutableSortedMap.of("meter", meter);
        final SortedMap<String, Timer> timers = ImmutableSortedMap.of();
        ...
        final List<MetricDatum> expectedMetrics = ImmutableList.of(
                new MetricDatum().withMetricName("meter.count").withValue(1.0).withTimestamp(new Date(timestamp)),
                new MetricDatum().withMetricName("meter.mean_rate").withValue(2.0).withTimestamp(new Date(timestamp)),
                new MetricDatum().withMetricName("meter.m1").withValue(3.0).withTimestamp(new Date(timestamp)),
                new MetricDatum().withMetricName("meter.m5").withValue(4.0).withTimestamp(new Date(timestamp)),
                new MetricDatum().withMetricName("meter.m15").withValue(5.0).withTimestamp(new Date(timestamp))
        );
    ...
    public void shouldReportMetersToCloudWatchWithCounterDifferential() {
        ...
        final List<MetricDatum> expectedMetrics1 = ImmutableList.of(
                new MetricDatum().withMetricName("meter.count").withValue(1.0).withTimestamp(new Date(timestamp)),
                new MetricDatum().withMetricName("meter.mean_rate").withValue(2.0).withTimestamp(new Date(timestamp)),
                new MetricDatum().withMetricName("meter.m1").withValue(3.0).withTimestamp(new Date(timestamp)),
                new MetricDatum().withMetricName("meter.m5").withValue(4.0).withTimestamp(new Date(timestamp)),
        ...
        final List<MetricDatum> expectedMetrics2 = ImmutableList.of(
                new MetricDatum().withMetricName("meter.count").withValue(2.0).withTimestamp(new Date(timestamp)),
                new MetricDatum().withMetricName("meter.mean_rate").withValue(2.0).withTimestamp(new Date(timestamp)),
                new MetricDatum().withMetricName("meter.m1").withValue(3.0).withTimestamp(new Date(timestamp)),
                new MetricDatum().withMetricName("meter.m5").withValue(4.0).withTimestamp(new Date(timestamp)),
                new MetricDatum().withMetricName("meter.m15").withValue(5.0).withTimestamp(new Date(timestamp))
    ...
    public void shouldReportTimersToCloudWatch() {
        ...
        final SortedMap<String, Histogram> histograms = ImmutableSortedMap.of();
        final SortedMap<String, Meter> meters = ImmutableSortedMap.of();
        final SortedMap<String, Timer> timers = ImmutableSortedMap.of("timer", timer);
        ...
        final List<MetricDatum> expectedMetrics = ImmutableList.of(
                new MetricDatum().withMetricName("timer.count").withValue(1.0).withTimestamp(new Date(timestamp)),
                new MetricDatum().withMetricName("timer.mean_rate").withValue(2.0).withTimestamp(new Date(timestamp)).withUnit(StandardUnit.None),
                new MetricDatum().withMetricName("timer.m1").withValue(3.0).withTimestamp(new Date(timestamp)).withUnit(StandardUnit.None),
                new MetricDatum().withMetricName("timer.m5").withValue(4.0).withTimestamp(new Date(timestamp)).withUnit(StandardUnit.None),
                new MetricDatum().withMetricName("timer.m15").withValue(5.0).withTimestamp(new Date(timestamp)).withUnit(StandardUnit.None),
                new MetricDatum().withMetricName("timer.max").withValue(0.006).withTimestamp(new Date(timestamp)).withUnit(StandardUnit.Microseconds),
                new MetricDatum().withMetricName("timer.min").withValue(0.007).withTimestamp(new Date(timestamp)).withUnit(StandardUnit.Microseconds),
                new MetricDatum().withMetricName("timer.mean").withValue(0.008).withTimestamp(new Date(timestamp)).withUnit(StandardUnit.Microseconds),
                new MetricDatum().withMetricName("timer.stddev").withValue(0.009).withTimestamp(new Date(timestamp)).withUnit(StandardUnit.Microseconds),
                new MetricDatum().withMetricName("timer.median").withValue(0.001).withTimestamp(new Date(timestamp)).withUnit(StandardUnit.Microseconds),
                new MetricDatum().withMetricName("timer.p75").withValue(0.002).withTimestamp(new Date(timestamp)).withUnit(StandardUnit.Microseconds),
                new MetricDatum().withMetricName("timer.p95").withValue(0.003).withTimestamp(new Date(timestamp)).withUnit(StandardUnit.Microseconds),
                new MetricDatum().withMetricName("timer.p98").withValue(0.004).withTimestamp(new Date(timestamp)).withUnit(StandardUnit.Microseconds),
                new MetricDatum().withMetricName("timer.p99").withValue(0.005).withTimestamp(new Date(timestamp)).withUnit(StandardUnit.Microseconds),
    ...
    public void shouldReportTimersToCloudWatchWithCounterDifferential() {
        ...
        final List<MetricDatum> expectedMetrics2 = ImmutableList.of(
                new MetricDatum().withMetricName("timer.count").withValue(2.0).withTimestamp(new Date(timestamp)),
                new MetricDatum().withMetricName("timer.mean_rate").withValue(2.0).withTimestamp(new Date(timestamp)).withUnit(StandardUnit.None),
                new MetricDatum().withMetricName("timer.m1").withValue(3.0).withTimestamp(new Date(timestamp)).withUnit(StandardUnit.None),
                new MetricDatum().withMetricName("timer.m5").withValue(4.0).withTimestamp(new Date(timestamp)).withUnit(StandardUnit.None),
                new MetricDatum().withMetricName("timer.m15").withValue(5.0).withTimestamp(new Date(timestamp)).withUnit(StandardUnit.None),
    ...
    private enum FixPrecision implements Function<MetricDatum, MetricDatum> {
        ...
        @Nullable
        @Override
        public MetricDatum apply(@Nullable MetricDatum metricDatum) {
